...
mod tests {
    ...
    fn tool_and_server_guidance_requires_the_explicit_snapshot_workflow() {
        ...
        assert!(instructions.contains("Rust, Python, JavaScript/JSX, TypeScript/TSX, and C++"));
